#!/usr/bin/env Rscript
# =============================================================================
# assign_taxonomy_v2.R
# ASV Taxonomie-Klassifizierung mit UNITE – alle vier Sequenzierläufe
# Pipeline v2: NextSeq mit loessErrfun + maxEE=c(5,2) + truncQ=3
...
output_dir <- file.path(base_path, "Data/Final/Taxonomy_v2")
...
# ----------------------------------------------------------------------------
# Alle vier Läufe klassifizieren (v2 Pfade!)
# ----------------------------------------------------------------------------
runs <- list(
  EC24_245 = file.path(base_path, "Data/Final/DADA2_Output_v2/EC24_245/seqtab_nochim.rds"),
  `3XX`    = file.path(base_path, "Data/Final/DADA2_Output_v2/3XX/seqtab_nochim.rds"),
  Popa     = file.path(base_path, "Data/Final/DADA2_Output_v2/Popa/seqtab_nochim.rds"),
  Buse     = file.path(base_path, "Data/Final/DADA2_Output_v2/Buse/seqtab_nochim.rds")
)
...
# ----------------------------------------------------------------------------
# Gemeinsame Taxonomie für seqtab_all (v2)
# ----------------------------------------------------------------------------
cat("\n========================================\n")
cat("Klassifiziere gemeinsame ASV-Tabelle (v2)\n")
cat("========================================\n")

seqtab_all <- readRDS(file.path(base_path, "Data/Final/DADA2_Output_v2/seqtab_all.rds"))
